 ...
 */
@SpringBootTest
@DisplayName("MinimumPercentage Tests")
class MinimumPercentageTest {

    @Autowired
    private MinimumPercentage minimumPercentage;
    ...
    class BasicCalculations {
        ...
        void basicSample() {
            ...
            int result = minimumPercentage.calculate(numbers);
            // Then
    ...
    class InvalidInputHandling {
        ...
        void nullInput() {
            assertThatThrownBy(() -> minimumPercentage.calculate(null))
    ...
    class FormulaVerification {
        ...
        void verifyFormula(int[] input, int expected, String description) {
            int result = minimumPercentage.calculate(input);
            assertThat(result)
    ...
    class MathematicalProperties {
        ...
        void resultIncreasesWithHigherPercentage() {
            ...
            int baseResult = minimumPercentage.calculate(base);

            // Higher: sum=310, threshold=200, result=110
            int[] higher = { 100, 100, 110 };
            int higherResult = minimumPercentage.calculate(higher);
        ...
        void addingAtThresholdNoChange() {
            ...
            int originalResult = minimumPercentage.calculate(original);
            // originalResult = 200 - 100 = 100

            int[] withExtra = { 100, 100, 100 };
            int withExtraResult = minimumPercentage.calculate(withExtra);
        ...
        void orderDoesNotMatter() {
            ...
            int result1 = minimumPercentage.calculate(order1);
            int result2 = minimumPercentage.calculate(order2);
            int result3 = minimumPercentage.calculate(order3);
