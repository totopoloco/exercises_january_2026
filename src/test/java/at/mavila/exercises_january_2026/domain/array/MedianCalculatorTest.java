...
/**
 * TDD Test Cases for MedianCalculator.
 *
...
class MedianCalculatorTest {
    ...
    void testMergeAndCalculate_Example1_OddTotalLength() {
        ...
        double result = this.medianCalculator.mergeAndCalculate(
    ...
    void testMergeAndCalculate_FirstArrayNull_ThrowsException() {
        assertThatThrownBy(() -> this.medianCalculator.mergeAndCalculate(null, new int[] { 1, 2, 3 }))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void testMergeAndCalculate_SecondArrayNull_ThrowsException() {
        assertThatThrownBy(() -> this.medianCalculator.mergeAndCalculate(new int[] { 1, 2, 3 }, null))
                .isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    void testMergeAndCalculate_BothArraysNull_ThrowsException() {
        assertThatThrownBy(() -> this.medianCalculator.mergeAndCalculate(null, null))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void testMergeAndCalculate_BothArraysEmpty_ThrowsException() {
        ...
        double mergeAndCalculate = this.medianCalculator.mergeAndCalculate(new int[] {}, new int[] {});
    ...
    void testMergeAndCalculate_LargeArrays_MaxSize() {
        ...
        double result = this.medianCalculator.mergeAndCalculate(nums1, nums2);
    ...
    void testMergeAndCalculate_LargeArrays_OneEmpty() {
        ...
        double result = this.medianCalculator.mergeAndCalculate(nums1, new int[] {});
        assertThat(result).isEqualTo(999.5);
    }
