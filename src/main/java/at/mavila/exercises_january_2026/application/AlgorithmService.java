...
public class AlgorithmService {
    ...
    private final NewtonRaphsonRootFinder newtonRaphsonRootFinder;
    ...
    public NewtonRaphsonResult findPolynomialRoot(final PolynomialRootRequest request) {
        ...
        final BigDecimal effectiveEpsilon = Objects.isNull(request.epsilon()) ? DEFAULT_EPSILON : request.epsilon();
        final int effectiveMaxIterations = Objects.isNull(request.maxIterations()) ? DEFAULT_MAX_ITERATIONS
