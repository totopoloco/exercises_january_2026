...
/**
 * Domain service for converting between Roman numerals and integers.
 *
 * <p>
 ...
 * <h2>Algorithm</h2>
 * <p>
 * Single-pass iteration with look-ahead comparison.
 ...
 * <h2>Complexity</h2>
 * <ul>
 * <li><b>Time:</b> O(n) where n is the length of the input string</li>
...
public class RomanNumberProcessor {
  ...
  public int romanToInt(final String roman) {
    ...
    for (int i = 0; i < roman.length(); i++) {
      ...
      // Look ahead to check if this is a subtraction case
    ...
    for (int i = 0; i < roman.length(); i++) {
      ...
      if (previousChar != null) {
        ...
        if (previousValue < currentValue) {
          ...
          // Check for multiple subtraction (e.g., IIV, XXC)
   ...
   * <h2>Complexity</h2>
   * <ul>
   * <li><b>Time:</b> O(1) - fixed number of symbols (13)</li>
   * <li><b>Space:</b> O(1) - maximum Roman numeral length is bounded</li>
   * </ul>
   *
